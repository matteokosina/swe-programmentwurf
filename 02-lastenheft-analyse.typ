...
#table(
    ...
    [
        ...
        #table(columns: 6, [Produktname],[ProduktID], [Hersteller], [Lieferant], [PreisProStk], [Beschreibung],[Betonschraube Ultracut FBS II],[25243996], [FISCHER], [Bauhaus], [2.6], [Sechskantkopf,
10 x 120 mm],[...],[...], [...], [...], [...], [...] )
...
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    table.header(
...
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    ...
    [MitarbeiterID], [Integer], [Verweis auf eindeutige Kennung eines Mitarbeiters],
    [Schriftart], [String], [Gibt den Namen der Schriftart an, in welcher die Texte in der GUI erscheinen],
    [Schriftgröße], [Float], [Gibt die Schriftgröße des angezeigten Textes an],
    [Akzentfarbe], [RGB(Integer, Integer, Integer)], [Beschreibt die Farbe für vorgehobene Inhalte (z.B. Farbe eines Primärbuttons)],
    [DunklerModus], [Boolean], [Wenn auf TRUE gesetzt wird alles im dunklen Modus angezeigt (z.B. der Hintergrund), sonst der helle Modus],
    [StandardDrucker], [String], [Verweis auf den vom Benutzer als „Standard“ ausgewählten Drucker (IP-Adresse des Druckers)]
)<ref:gui>
*Zugriffsrechte* 
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    table.header(
...
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    ...
    [Firma], [String], [Firma (falls es ein Firmenkunde ist, ansonsten leerer String)],
    [SteuerID], [String], [SteuerID (falls es ein Firmenkunde ist, ansonsten leerer String)],
    [Vorname], [String], [Vorname des Kunden / der Ansprechperson bei der Firma],
    [Nachname], [String], [Nachname des Kunden / der Ansprechperson bei der Firma],
...
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    ...
    [Titel], [String], [Titel des Auftrags (z.B. für spätere Druck-Anwendungen). Hieraus wird dann auch der Dateiname zum Abspeichern gebildet]
)<ref:kundenauftrag>
#pagebreak()
*Eigenauftrag*
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    ...
    [Beschreibung], [String], [Beschreibung oder zusätzliche Notiz],
    [Titel], [String], [Titel des Auftrags (z.B. für spätere Druck-Anwendungen). Hieraus wird dann auch der Dateiname zum Abspeichern gebildet],
    [Verwendungszweck], [String], [Für was wurde dieser Auftrag erstellt (z.B. Reparatur)],
    [VerknüpfteAufträge], [Liste an Integern], [Optional: Liste an verknüpften Kundenaufträgen (beispielsweise bei Beschaffung relevant)]
)<ref:eigenauftrag>
*Angebote*
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    table.header(
    ...
    [Beschreibung], [String], [Beschreibung oder zusätzliche Notiz],
    [Titel], [String], [Titel des Angebots (z.B. für spätere Druck-Anwendungen). Hieraus wird dann auch der Dateiname zum Abspeichern gebildet]
)<ref:angebot>
#pagebreak()
*Lieferungen*
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
...
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    ...
    [Beschreibung], [String], [Beschreibung oder zusätzliche Notiz],
    [Titel], [String], [Titel der Rechnung (z.B. für spätere Druck-Anwendungen). Hieraus wird dann auch der Dateiname zum Abspeichern gebildet]
)<ref:rechnung>
*Termin*
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    table.header(
...
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    ...
    [Seriennummer], [String], [Beschreibt aus welche Serie / Charge die Maschine kommt],
    ...
    [Wartungsanforderungen], [String], [Beschreibt wie und wann die Maschine gewartet werden muss],
...
#table(columns: 3, fill: (x, y) => if y == 0 { internColor },
    ...
    [AltText], [String], [Text der angezeigt werden kann, wenn die Datei nicht geladen wird (z.B. schlechte Internet-Verbindung). Besonders relevant bei Bildern]
)<ref:datei>
=== Produktleistungen
#table(
    columns: 2,
